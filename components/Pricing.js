    ...
    <ContainerWrap>
      ...
      <PricingCards>
        <PricingCard>
          ...
          <PricingCardItem>
            ...
            <Text color={textMuted}> Enjoy the benefits of Dash Directory without any cost</Text>
          </PricingCardItem>
          <PricingCardItem>
            <svg
              xmlns='http://www.w3.org/2000/svg'
            ...
            <Text color={textMuted}>Task and event management functionalities</Text>
          </PricingCardItem>
          <PricingCardItem>
            <svg
              xmlns='http://www.w3.org/2000/svg'
            ...
            <Text color={textMuted}>Priority customer support for prompt assistance</Text>
          </PricingCardItem>
        </PricingCard>
        <PricingCard>
          <Text
      ...
      <PricingAdditional>
        ...
        <Paragraph size={500} color={textMuted} marginTop={18} lineHeight={1.75} textAlign='center'>
          ...
          announcements related to Dash Directory, ensuring they stay up to date with the
          platform&apos;s developments.
        </Paragraph>
        <br />
